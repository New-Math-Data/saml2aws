...
3. Open the terminal in the root of this repo and run the following command
    - `go build -o nmd-saml2aws ./cmd.saml2aws`

4. Find the AWS role and account you want cli creds for.
...
5. Open the ~/.saml2aws file with an editor
...
7. Authenticate and you should see the creds refresh in `~/.aws/credentials`